...
def parse_args():
    ...
    parser.add_argument('--adapter', choices=['LoRA', 'AdapterP', 'AdapterH', 'Parallel', 'DoRA', 'SVDDoRA', 'AdaSVD', 'SVDLoRA', 'SVDLoRA_v2', 'SVDLoRA_v3', 'SVDLoRA_res_v1', 'SVDLoRA_res_v2', 'SVDLoRA_res_v3', 'SVDLoRA_res_v4'], required=True)
