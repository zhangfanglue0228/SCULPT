...
from utils.model_utils import get_trainer, make_sequential_train
...
train_data_path: str = "./ft-training_set/final_splits/commonsense_train_15k.json"
valid_data_path: str = "./ft-training_set/final_splits/commonsense_valid_1k.json"
